...
class Memes{
    constructor($canvas, $topTextInput, $bottomTextInput, $imageInput, $downloadButton){
    ...
    createMeme(){
        ...
        if (this.$imageInput.files && this.$imageInput.files[0]){
           /* FileReader allows the reading of a file asynchronously */
            ...
            console.log('This will geet printed first')
        }  
    }
    ...
    addEventListener(){
      ...
      /*  attach addeventListener to multiple nodes at the same time take note of this    */
